...
class UGPlayerPhase2_99109393:
    ...
    def proposer_strategy(self, round_number: int) -> int:
        ...
        # Add noise to the offer as expected in this scenario
        noise = random.gauss(0, 0.05)
        noisy_offer = min(max(int(offer + noise * 100), 0), 100)  # Ensure offer is within 0 to 100
    ...
    def responder_strategy(self, round_number: int, offer: int) -> bool:
        ...
        """
        # Consider the noise in the reported offer
    ...
    def result(self, round_number: int, score: int) -> None:
        ...
        """
        # Assume 20% probability that the action was misreported
        if random.random() < 0.2:
            score = 1 - score  # Flip the result
